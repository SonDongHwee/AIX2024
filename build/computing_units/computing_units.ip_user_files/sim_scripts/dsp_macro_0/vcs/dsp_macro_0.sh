...
design_libs=(xbip_dsp48_wrapper_v3_0_5 xbip_utils_v3_0_11 xbip_pipe_v3_0_7 dsp_macro_v1_0_4 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work dsp_macro_v1_0_4 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_macro_0 -o dsp_macro_0_simv
}
