...
begin
    //CONV06 ver.
    $readmemh("../../inout_data_sw/log_param/CONV06_param_weight_32b.hex",weight_register);
end
endtask
...
begin
    //CONV06 ver.
    $readmemh("../../inout_data_sw/log_param/CONV06_param_biases_32b.hex",bias_register);
end
endtask
...
begin
    //CONV06 ver.
    $readmemh("../../inout_data_sw/log_feamap/CONV06_input_32b.hex",ifm_register);
end
endtask
