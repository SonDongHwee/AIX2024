...
#
# Script generated by Vivado on Thu Mar 28 09:24:57 +0900 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : spram_208x256.sh
...
#
# Usage        : spram_208x256.sh
#                spram_208x256.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spram_208x256.sh [-reset_run]
#                spram_208x256.sh [-reset_log]
#                spram_208x256.sh [-help]
#
...
# script info
echo -e "spram_208x256.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spram_208x256.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram_208x256 xil_defaultlib.spram_208x256 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spram_208x256 -key {Behavioral:sim_1:Functional:spram_208x256} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spram_208x256.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spram_208x256.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spram_208x256.sh [-help]\n\
Usage: spram_208x256.sh [-step]\n\
Usage: spram_208x256.sh [-lib_map_path]\n\
Usage: spram_208x256.sh [-reset_run]\n\
Usage: spram_208x256.sh [-reset_log]\n\
Usage: spram_208x256.sh [-keep_index]\n\
Usage: spram_208x256.sh [-noclean_files]\n\n\
