...
//{{{
/* ##################################  NOTE ################################## */
// After changing this file (define.v), you should copy this file into
// 'build/[project_name].sim/sim_1/behav/xsim'
// All the outputs of the Vivado simulations are also stored in that directory
/* ########################################################################### */


/* ################################# CONV 00 ################################# */
// Note that the inputs of Conv 00 is NOT quantized; which means 32-bit data
parameter IFM_WIDTH = 256;
parameter IFM_HEIGHT = 256;
parameter IFM_DATA_SIZE     = IFM_HEIGHT*IFM_WIDTH;		// Layer 00
...
parameter IFM_FILE   		 = "../../inout_data_sw/log_feamap_32bit/CONV00_input.hex"; 
