...
// --------------------------------------------
// declare variables
reg  [23:0] mac_array_0_out [0:3];
reg  [23:0] mac_array_1_out [0:3];
reg  [23:0] mac_array_2_out [0:3];
reg  [23:0] mac_array_3_out [0:3];
wire [15:0] bias_to_add_0, bias_to_add_1, bias_to_add_2, bias_to_add_3; 
wire [23:0] mac_array_0_out_add_bias [0:3];
wire [23:0] mac_array_1_out_add_bias [0:3];
wire [23:0] mac_array_2_out_add_bias [0:3];
wire [23:0] mac_array_3_out_add_bias [0:3];
...
assign mac_array_0_out_add_bias[0] = (is_CONV00) ? (mac_array_0_out[0] + {{8{bias_to_add_0[15]}}, bias_to_add_0})
                                                 : (1'b0);
assign mac_array_0_out_add_bias[1] = (is_CONV00) ? (mac_array_0_out[1] + {{8{bias_to_add_1[15]}}, bias_to_add_1})
                                                 : (1'b0);
assign mac_array_0_out_add_bias[2] = (is_CONV00) ? (mac_array_0_out[2] + {{8{bias_to_add_2[15]}}, bias_to_add_2})
                                                 : (1'b0);
assign mac_array_0_out_add_bias[3] = (is_CONV00) ? (mac_array_0_out[3] + {{8{bias_to_add_3[15]}}, bias_to_add_3})
                                                 : (1'b0);

assign mac_array_1_out_add_bias[0] = (is_CONV00) ? (mac_array_1_out[0] + {{8{bias_to_add_0[15]}}, bias_to_add_0})
                                                 : (1'b0);
assign mac_array_1_out_add_bias[1] = (is_CONV00) ? (mac_array_1_out[1] + {{8{bias_to_add_1[15]}}, bias_to_add_1})
                                                 : (1'b0);
assign mac_array_1_out_add_bias[2] = (is_CONV00) ? (mac_array_1_out[2] + {{8{bias_to_add_2[15]}}, bias_to_add_2})
                                                 : (1'b0);
assign mac_array_1_out_add_bias[3] = (is_CONV00) ? (mac_array_1_out[3] + {{8{bias_to_add_3[15]}}, bias_to_add_3})
                                                 : (1'b0);

assign mac_array_2_out_add_bias[0] = (is_CONV00) ? (mac_array_2_out[0] + {{8{bias_to_add_0[15]}}, bias_to_add_0})
                                                 : (1'b0);
assign mac_array_2_out_add_bias[1] = (is_CONV00) ? (mac_array_2_out[1] + {{8{bias_to_add_1[15]}}, bias_to_add_1})
                                                 : (1'b0);
assign mac_array_2_out_add_bias[2] = (is_CONV00) ? (mac_array_2_out[2] + {{8{bias_to_add_2[15]}}, bias_to_add_2})
                                                 : (1'b0);
assign mac_array_2_out_add_bias[3] = (is_CONV00) ? (mac_array_2_out[3] + {{8{bias_to_add_3[15]}}, bias_to_add_3})
                                                 : (1'b0);

assign mac_array_3_out_add_bias[0] = (is_CONV00) ? (mac_array_3_out[0] + {{8{bias_to_add_0[15]}}, bias_to_add_0})
                                                 : (1'b0);
assign mac_array_3_out_add_bias[1] = (is_CONV00) ? (mac_array_3_out[1] + {{8{bias_to_add_1[15]}}, bias_to_add_1})
                                                 : (1'b0);
assign mac_array_3_out_add_bias[2] = (is_CONV00) ? (mac_array_3_out[2] + {{8{bias_to_add_2[15]}}, bias_to_add_2})
                                                 : (1'b0);                                                                                                                                                                                                                                                 
assign mac_array_3_out_add_bias[3] = (is_CONV00) ? (mac_array_3_out[3] + {{8{bias_to_add_3[15]}}, bias_to_add_3})
                                                 : (1'b0);                                                                                      
...
generate
  for (g = 0; g < 4; g = g + 1) begin : gen_quant_ReLU
    assign mac_array_0_out_quant[g] = mac_array_0_out_add_bias[g][23] ? 1'b0
                                    : mac_array_0_out_add_bias[g][(SCALE_FACTOR - NEXT_LAYER_INPUT_M)+:8];
    assign mac_array_1_out_quant[g] = mac_array_1_out_add_bias[g][23] ? 1'b0
                                    : mac_array_1_out_add_bias[g][(SCALE_FACTOR - NEXT_LAYER_INPUT_M)+:8];
    assign mac_array_2_out_quant[g] = mac_array_2_out_add_bias[g][23] ? 1'b0
                                    : mac_array_2_out_add_bias[g][(SCALE_FACTOR - NEXT_LAYER_INPUT_M)+:8];
    assign mac_array_3_out_quant[g] = mac_array_3_out_add_bias[g][23] ? 1'b0
...
always @ (*) begin // assign din and win for 4 MAC arrays
  if (is_CONV00) begin
    ...
    for (fil_iter = 0; fil_iter < 8; fil_iter = fil_iter + 2) begin
      ...
      win[fil_iter  ][  8+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 12)][get_WGT_offset(12)+:8];
      win[fil_iter  ][ 16+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 24)][get_WGT_offset(24)+:8];
      win[fil_iter  ][ 24+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  1)][get_WGT_offset( 1)+:8];
      win[fil_iter  ][ 32+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 13)][get_WGT_offset(13)+:8];
      win[fil_iter  ][ 40+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 25)][get_WGT_offset(25)+:8];
      win[fil_iter  ][ 48+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  2)][get_WGT_offset( 2)+:8];
      win[fil_iter  ][ 56+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 14)][get_WGT_offset(14)+:8];
      win[fil_iter  ][ 64+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 26)][get_WGT_offset(26)+:8];
      win[fil_iter  ][ 72+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  4)][get_WGT_offset( 4)+:8];
      win[fil_iter  ][ 80+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 16)][get_WGT_offset(16)+:8];
      win[fil_iter  ][ 88+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 28)][get_WGT_offset(28)+:8];
      win[fil_iter  ][ 96+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  5)][get_WGT_offset( 5)+:8];
      win[fil_iter  ][104+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 17)][get_WGT_offset(17)+:8];
      win[fil_iter  ][112+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 29)][get_WGT_offset(29)+:8];
      win[fil_iter  ][120+:8] = 1'b0;
      win[fil_iter+1][  0+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  6)][get_WGT_offset( 6)+:8];
      win[fil_iter+1][  8+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 18)][get_WGT_offset(18)+:8];
      win[fil_iter+1][ 16+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 30)][get_WGT_offset(30)+:8];
      win[fil_iter+1][ 24+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  8)][get_WGT_offset( 8)+:8];
      win[fil_iter+1][ 32+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 20)][get_WGT_offset(20)+:8];
      win[fil_iter+1][ 40+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 32)][get_WGT_offset(32)+:8];
      win[fil_iter+1][ 48+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1),  9)][get_WGT_offset( 9)+:8];
      win[fil_iter+1][ 56+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 21)][get_WGT_offset(21)+:8];
      win[fil_iter+1][ 64+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 33)][get_WGT_offset(33)+:8];
      win[fil_iter+1][ 72+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 10)][get_WGT_offset(10)+:8];
      win[fil_iter+1][ 80+:8] = weight[get_WGT_index(filter_set + (fil_iter>>1), 22)][get_WGT_offset(22)+:8];
      ...
      COMMAND_COMPUTE: begin
        ...
        case (state)
          ...
          STATE_RUN: begin // Do MAC, max-pool, and data send in parallel
            ...
            // --------------------------------------------
            if (!pool_done) begin
              if (valid_mac) begin // start pooling only when the MAC result is valid
                if (is_CONV00) begin
                  valid_pool <= 1'b1;
                  for (i = 0; i < 4; i = i + 1) begin
              ...
              if (valid_pool) begin // start data sending only when the max-pool result is valid
                if (is_CONV00) begin
                  if (bias_num[1:0] == 2'b11) begin
                    ...
                    if (send_counter == OUTPUT_SIZE - 1) begin // sending the last data
                      send_done <= 1'b1;
                      valid_o <= 1'b0;
                    end else begin
                      send_done <= 1'b0;
