...
//Command     : generate_target yolo_design_1.bd
//Design      : yolo_design_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module m00_couplers_imp_13GWGDJ
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_5VS8C3
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module microblaze_0_local_memory_imp_N8EZAK
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > yolo_design_1 microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  yolo_design_1_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  yolo_design_1_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  yolo_design_1_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  yolo_design_1_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  yolo_design_1_lmb_bram_0 lmb_bram
...
module s00_couplers_imp_14DO5G8
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
(* CORE_GENERATION_INFO = "yolo_design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=yolo_design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=3,da_clkrst_cnt=1,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "yolo_design_1.hwdef" *) 
module yolo_design_1
   (ddr2_sdram_addr,
    ddr2_sdram_ba,
    ddr2_sdram_cas_n,
    ddr2_sdram_ck_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN yolo_design_1_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  wire sys_clock_1;
  wire [31:0]yolo_engine_ip_0_M_ARADDR;
  wire [1:0]yolo_engine_ip_0_M_ARBURST;
  wire [3:0]yolo_engine_ip_0_M_ARCACHE;
  wire [3:0]yolo_engine_ip_0_M_ARID;
  wire [7:0]yolo_engine_ip_0_M_ARLEN;
  wire [1:0]yolo_engine_ip_0_M_ARLOCK;
  wire [2:0]yolo_engine_ip_0_M_ARPROT;
  wire [3:0]yolo_engine_ip_0_M_ARQOS;
  wire yolo_engine_ip_0_M_ARREADY;
  wire [2:0]yolo_engine_ip_0_M_ARSIZE;
  wire [3:0]yolo_engine_ip_0_M_ARUSER;
  wire yolo_engine_ip_0_M_ARVALID;
  wire [31:0]yolo_engine_ip_0_M_AWADDR;
  wire [1:0]yolo_engine_ip_0_M_AWBURST;
  wire [3:0]yolo_engine_ip_0_M_AWCACHE;
  wire [3:0]yolo_engine_ip_0_M_AWID;
  wire [7:0]yolo_engine_ip_0_M_AWLEN;
  wire [1:0]yolo_engine_ip_0_M_AWLOCK;
  wire [2:0]yolo_engine_ip_0_M_AWPROT;
  wire [3:0]yolo_engine_ip_0_M_AWQOS;
  wire yolo_engine_ip_0_M_AWREADY;
  wire [2:0]yolo_engine_ip_0_M_AWSIZE;
  wire [3:0]yolo_engine_ip_0_M_AWUSER;
  wire yolo_engine_ip_0_M_AWVALID;
  wire [3:0]yolo_engine_ip_0_M_BID;
  wire yolo_engine_ip_0_M_BREADY;
  wire [1:0]yolo_engine_ip_0_M_BRESP;
  wire [0:0]yolo_engine_ip_0_M_BUSER;
  wire yolo_engine_ip_0_M_BVALID;
  wire [31:0]yolo_engine_ip_0_M_RDATA;
  wire [3:0]yolo_engine_ip_0_M_RID;
  wire yolo_engine_ip_0_M_RLAST;
  wire yolo_engine_ip_0_M_RREADY;
  wire [1:0]yolo_engine_ip_0_M_RRESP;
  wire [3:0]yolo_engine_ip_0_M_RUSER;
  wire yolo_engine_ip_0_M_RVALID;
  wire [31:0]yolo_engine_ip_0_M_WDATA;
  wire yolo_engine_ip_0_M_WLAST;
  wire yolo_engine_ip_0_M_WREADY;
  wire [3:0]yolo_engine_ip_0_M_WSTRB;
  wire [3:0]yolo_engine_ip_0_M_WUSER;
  wire yolo_engine_ip_0_M_WVALID;
  ...
  yolo_design_1_axi_smc_0 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .S02_AXI_araddr(yolo_engine_ip_0_M_ARADDR),
        .S02_AXI_arburst(yolo_engine_ip_0_M_ARBURST),
        .S02_AXI_arcache(yolo_engine_ip_0_M_ARCACHE),
        .S02_AXI_arid(yolo_engine_ip_0_M_ARID),
        .S02_AXI_arlen(yolo_engine_ip_0_M_ARLEN),
        .S02_AXI_arlock(yolo_engine_ip_0_M_ARLOCK[0]),
        .S02_AXI_arprot(yolo_engine_ip_0_M_ARPROT),
        .S02_AXI_arqos(yolo_engine_ip_0_M_ARQOS),
        .S02_AXI_arready(yolo_engine_ip_0_M_ARREADY),
        .S02_AXI_arsize(yolo_engine_ip_0_M_ARSIZE),
        .S02_AXI_aruser(yolo_engine_ip_0_M_ARUSER),
        .S02_AXI_arvalid(yolo_engine_ip_0_M_ARVALID),
        .S02_AXI_awaddr(yolo_engine_ip_0_M_AWADDR),
        .S02_AXI_awburst(yolo_engine_ip_0_M_AWBURST),
        .S02_AXI_awcache(yolo_engine_ip_0_M_AWCACHE),
        .S02_AXI_awid(yolo_engine_ip_0_M_AWID),
        .S02_AXI_awlen(yolo_engine_ip_0_M_AWLEN),
        .S02_AXI_awlock(yolo_engine_ip_0_M_AWLOCK[0]),
        .S02_AXI_awprot(yolo_engine_ip_0_M_AWPROT),
        .S02_AXI_awqos(yolo_engine_ip_0_M_AWQOS),
        .S02_AXI_awready(yolo_engine_ip_0_M_AWREADY),
        .S02_AXI_awsize(yolo_engine_ip_0_M_AWSIZE),
        .S02_AXI_awuser(yolo_engine_ip_0_M_AWUSER),
        .S02_AXI_awvalid(yolo_engine_ip_0_M_AWVALID),
        .S02_AXI_bid(yolo_engine_ip_0_M_BID),
        .S02_AXI_bready(yolo_engine_ip_0_M_BREADY),
        .S02_AXI_bresp(yolo_engine_ip_0_M_BRESP),
        .S02_AXI_buser(yolo_engine_ip_0_M_BUSER),
        .S02_AXI_bvalid(yolo_engine_ip_0_M_BVALID),
        .S02_AXI_rdata(yolo_engine_ip_0_M_RDATA),
        .S02_AXI_rid(yolo_engine_ip_0_M_RID),
        .S02_AXI_rlast(yolo_engine_ip_0_M_RLAST),
        .S02_AXI_rready(yolo_engine_ip_0_M_RREADY),
        .S02_AXI_rresp(yolo_engine_ip_0_M_RRESP),
        .S02_AXI_ruser(yolo_engine_ip_0_M_RUSER),
        .S02_AXI_rvalid(yolo_engine_ip_0_M_RVALID),
        .S02_AXI_wdata(yolo_engine_ip_0_M_WDATA),
        .S02_AXI_wlast(yolo_engine_ip_0_M_WLAST),
        .S02_AXI_wready(yolo_engine_ip_0_M_WREADY),
        .S02_AXI_wstrb(yolo_engine_ip_0_M_WSTRB),
        .S02_AXI_wuser(yolo_engine_ip_0_M_WUSER),
        .S02_AXI_wvalid(yolo_engine_ip_0_M_WVALID),
        .aclk(microblaze_0_Clk),
        .aclk1(mig_7series_0_ui_clk),
        .aresetn(rst_mig_7series_0_81M_peripheral_aresetn));
  yolo_design_1_axi_uartlite_0_0 axi_uartlite_0
  ...
  yolo_design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk),
        .clk_out2(clk_wiz_0_clk_out2),
        .locked(clk_wiz_0_locked),
        .resetn(reset_1));
  yolo_design_1_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > yolo_design_1 microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  yolo_design_1_microblaze_0_0 microblaze_0
  ...
  yolo_design_1_microblaze_0_axi_periph_0 microblaze_0_axi_periph
       (.ACLK(microblaze_0_Clk),
  ...
  microblaze_0_local_memory_imp_N8EZAK microblaze_0_local_memory
  ...
  yolo_design_1_mig_7series_0_0 mig_7series_0
       (.aresetn(rst_mig_7series_0_81M_peripheral_aresetn),
  ...
  yolo_design_1_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
  ...
  yolo_design_1_rst_mig_7series_0_81M_0 rst_mig_7series_0_81M
       (.aux_reset_in(1'b1),
  ...
  yolo_design_1_yolo_engine_ip_0_0 yolo_engine_ip_0
       (.M_ARADDR(yolo_engine_ip_0_M_ARADDR),
        .M_ARBURST(yolo_engine_ip_0_M_ARBURST),
        .M_ARCACHE(yolo_engine_ip_0_M_ARCACHE),
        .M_ARID(yolo_engine_ip_0_M_ARID),
        .M_ARLEN(yolo_engine_ip_0_M_ARLEN),
        .M_ARLOCK(yolo_engine_ip_0_M_ARLOCK),
        .M_ARPROT(yolo_engine_ip_0_M_ARPROT),
        .M_ARQOS(yolo_engine_ip_0_M_ARQOS),
        .M_ARREADY(yolo_engine_ip_0_M_ARREADY),
        .M_ARSIZE(yolo_engine_ip_0_M_ARSIZE),
        .M_ARUSER(yolo_engine_ip_0_M_ARUSER),
        .M_ARVALID(yolo_engine_ip_0_M_ARVALID),
        .M_AWADDR(yolo_engine_ip_0_M_AWADDR),
        .M_AWBURST(yolo_engine_ip_0_M_AWBURST),
        .M_AWCACHE(yolo_engine_ip_0_M_AWCACHE),
        .M_AWID(yolo_engine_ip_0_M_AWID),
        .M_AWLEN(yolo_engine_ip_0_M_AWLEN),
        .M_AWLOCK(yolo_engine_ip_0_M_AWLOCK),
        .M_AWPROT(yolo_engine_ip_0_M_AWPROT),
        .M_AWQOS(yolo_engine_ip_0_M_AWQOS),
        .M_AWREADY(yolo_engine_ip_0_M_AWREADY),
        .M_AWSIZE(yolo_engine_ip_0_M_AWSIZE),
        .M_AWUSER(yolo_engine_ip_0_M_AWUSER),
        .M_AWVALID(yolo_engine_ip_0_M_AWVALID),
        .M_BID(yolo_engine_ip_0_M_BID),
        .M_BREADY(yolo_engine_ip_0_M_BREADY),
        .M_BRESP(yolo_engine_ip_0_M_BRESP),
        .M_BUSER(yolo_engine_ip_0_M_BUSER),
        .M_BVALID(yolo_engine_ip_0_M_BVALID),
        .M_RDATA(yolo_engine_ip_0_M_RDATA),
        .M_RID(yolo_engine_ip_0_M_RID),
        .M_RLAST(yolo_engine_ip_0_M_RLAST),
        .M_RREADY(yolo_engine_ip_0_M_RREADY),
        .M_RRESP(yolo_engine_ip_0_M_RRESP),
        .M_RUSER(yolo_engine_ip_0_M_RUSER),
        .M_RVALID(yolo_engine_ip_0_M_RVALID),
        .M_WDATA(yolo_engine_ip_0_M_WDATA),
        .M_WLAST(yolo_engine_ip_0_M_WLAST),
        .M_WREADY(yolo_engine_ip_0_M_WREADY),
        .M_WSTRB(yolo_engine_ip_0_M_WSTRB),
        .M_WUSER(yolo_engine_ip_0_M_WUSER),
        .M_WVALID(yolo_engine_ip_0_M_WVALID),
...
module yolo_design_1_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_13GWGDJ m00_couplers
  ...
  m01_couplers_imp_5VS8C3 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_14DO5G8 s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
