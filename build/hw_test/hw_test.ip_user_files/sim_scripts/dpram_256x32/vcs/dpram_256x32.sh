...
#                script (type 'dpram_256x32.sh -help' for more information).
#
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_7 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dpram_256x32 xil_defaultlib.glbl -o dpram_256x32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dpram_256x32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dpram_256x32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dpram_256x32_simv.daidir vcs_lib c.obj)
