...
#
# Script generated by Vivado on Sun Apr 28 15:23:11 +0900 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dpram_256x32.sh
...
#
# Usage        : dpram_256x32.sh
#                dpram_256x32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dpram_256x32.sh [-reset_run]
#                dpram_256x32.sh [-reset_log]
#                dpram_256x32.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_15 -L smartconnect_v1_0 -L xilinx_vip"

# script info
echo -e "dpram_256x32.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dpram_256x32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dpram_256x32 xil_defaultlib.dpram_256x32 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dpram_256x32 -key {Behavioral:sim_1:Functional:dpram_256x32} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f82d.protoinst" -protoinst "protoinst_files/yolo_design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dpram_256x32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dpram_256x32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dpram_256x32.sh [-help]\n\
Usage: dpram_256x32.sh [-step]\n\
Usage: dpram_256x32.sh [-lib_map_path]\n\
Usage: dpram_256x32.sh [-reset_run]\n\
Usage: dpram_256x32.sh [-reset_log]\n\
Usage: dpram_256x32.sh [-keep_index]\n\
Usage: dpram_256x32.sh [-noclean_files]\n\n\
