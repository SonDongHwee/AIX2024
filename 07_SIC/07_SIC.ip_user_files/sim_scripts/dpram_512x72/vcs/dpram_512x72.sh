...
#
# Script generated by Vivado on Wed Mar 27 17:08:29 +0900 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dpram_512x72.sh
...
#
# Usage        : dpram_512x72.sh
#                dpram_512x72.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dpram_512x72.sh [-reset_run]
#                dpram_512x72.sh [-reset_log]
#                dpram_512x72.sh [-help]
#
...
#                script (type 'dpram_512x72.sh -help' for more information).
#
...
# script info
echo -e "dpram_512x72.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dpram_512x72.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dpram_512x72 xil_defaultlib.glbl -o dpram_512x72_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dpram_512x72_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dpram_512x72_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dpram_512x72_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dpram_512x72.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dpram_512x72.sh [-help]\n\
Usage: dpram_512x72.sh [-step]\n\
Usage: dpram_512x72.sh [-lib_map_path]\n\
Usage: dpram_512x72.sh [-reset_run]\n\
Usage: dpram_512x72.sh [-reset_log]\n\
Usage: dpram_512x72.sh [-keep_index]\n\
Usage: dpram_512x72.sh [-noclean_files]\n\n\
